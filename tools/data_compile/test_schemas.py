...
def fixtures() -> dict:
    ...
    unit = {
        "schema_version": 2, "id": "rome:legionary", "display_name_key": "rome:unit.legionary", "description_key": "rome:unit.legionary_desc", "civ_id": "rome:module", "epoch_window": [5, 5], "class": "infantry", "tags": ["formation_capable"], "resource_costs": {"chunsa:food": 10}, "stats": {"hp": 100, "attack": 10, "range_millitiles": 1000, "speed_millitile_tick": 100, "morale": 80, "build_time_ticks": 40, "armor": {"cut": 0, "pierce": 0, "impact": 0}, "attack_damage_type": "cut"}, **availability(), "provenance": provenance(),
    }
    building = {
        "schema_version": 1, "id": "rome:forum", "civ_id": "rome:module", "display_name_key": "rome:building.forum", "description_key": "rome:building.forum_desc", "epoch_window": [5, 5], "kind": "civic", "footprint": {"width_cells": 2, "height_cells": 2, "blocks_movement": True}, "stats": {"hp": 1000, "armor": {"cut": 0, "pierce": 0, "impact": 0}}, "constructible": True, "resource_costs": {"chunsa:food": 50}, "build_time_ticks": 100, "dropoff_resources": [], "trains": [], "researches": [], "required_capabilities": [], "grants_capabilities": [], "recipes": [], **availability(), "provenance": provenance(),
    }
    tech = {
