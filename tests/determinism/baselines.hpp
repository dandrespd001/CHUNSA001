...
// re-registrar.
inline constexpr uint64_t AI_SKIRMISH_APERTURA_STATE = 0x3ea29cdf823f884cull;
inline constexpr uint64_t AI_SKIRMISH_APERTURA_CONTINUATION = 0x41be0cca5957ee00ull;
