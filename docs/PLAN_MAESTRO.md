...
| **1.8C** | SPEC-007 §9.2 · §20.5 | Los **30 recursos** en `data/resources/` con familia y edad · depósitos del mapa escalonados · **HUD por familias** (SPEC-006 Parte III) | Partida larga sin agotamiento prematuro · el HUD no desborda con 26 activos |
