...
| **1.8D** ⏳ | SPEC-007 §9.2 · §9.4 | **Contenido**: depósitos del mapa escalonados por edad y costes reales en los nuevos recursos | Partida larga sin agotamiento prematuro · **es el sprint de balance**, el que el panel avisó que puede desbordarse |
| **1.8E** | **SPEC-006 Parte IV** | **El HUD expone lo que el kernel ya puede**: costes visibles antes de actuar · asignación automática de constructores y progreso de obra · los 4 edificios construibles del catálogo | Ningún precio se aprende por rechazo · una obra sin constructor lo dice · un 5º edificio construible aparece **sin recompilar** |
| **1.9** | **SPEC-007 §12** | Recetas, `CRAFT=14`, edificio de conversión. Bronce, hierro forjado (con **caliza**), cal viva | Se fabrica bronce · las 11 pruebas de §12.6 · cadenas de profundidad **1** · el esquema ya traía `recipes` (§18.3) |
