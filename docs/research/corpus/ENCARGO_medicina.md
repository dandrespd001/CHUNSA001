...
Sustituye `medicina`, `medicina.md` y `medicina antigua y herbolaria, cirugia, teoria microbiana, antisepsia, vacunas, antibioticos, veterinaria y salud del ganado, epidemias y su efecto demografico` y lánzalo.
...
Asuntos a cubrir: medicina antigua y herbolaria, cirugia, teoria microbiana, antisepsia, vacunas, antibioticos, veterinaria y salud del ganado, epidemias y su efecto demografico
...
`docs/research/corpus/extractos/medicina.md`
