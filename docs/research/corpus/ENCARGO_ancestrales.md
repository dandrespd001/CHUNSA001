...
Sustituye `ancestrales`, `ancestrales.md` y `metalurgia andina, riego nilotico y mesopotamico, agricultura mesoamericana (chinampas, milpa), textiles, ceramica, construccion megalitica, navegacion polinesia` y lánzalo.
...
Asuntos a cubrir: metalurgia andina, riego nilotico y mesopotamico, agricultura mesoamericana (chinampas, milpa), textiles, ceramica, construccion megalitica, navegacion polinesia
...
`docs/research/corpus/extractos/ancestrales.md`
