...
Sustituye `alimentacion`, `alimentacion.md` y `salazon, secado, ahumado, fermentacion, conserva en lata, refrigeracion, domesticacion animal, el caballo` y lánzalo.
...
Asuntos a cubrir: salazon, secado, ahumado, fermentacion, conserva en lata, refrigeracion, domesticacion animal, el caballo
...
`docs/research/corpus/extractos/alimentacion.md`
