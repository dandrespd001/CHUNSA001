...
Sustituye `agricultura`, `agricultura.md` y `rotacion de cultivos, arado, riego, abonado, seleccion de semillas, rendimiento por hectarea por epoca, revolucion verde` y lánzalo.
...
Asuntos a cubrir: rotacion de cultivos, arado, riego, abonado, seleccion de semillas, rendimiento por hectarea por epoca, revolucion verde
...
`docs/research/corpus/extractos/agricultura.md`
