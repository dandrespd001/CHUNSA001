...
Sustituye `nuclear`, `nuclear.md` y `fision, enriquecimiento de uranio, reactor, ciclo del combustible, residuos` y lánzalo.
...
Asuntos a cubrir: fision, enriquecimiento de uranio, reactor, ciclo del combustible, residuos
...
`docs/research/corpus/extractos/nuclear.md`
