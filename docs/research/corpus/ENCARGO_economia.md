...
Sustituye `economia`, `economia.md` y `trueque, moneda, credito, contabilidad por partida doble, mercantilismo, revolucion industrial, comercio a larga distancia` y lánzalo.
...
Asuntos a cubrir: trueque, moneda, credito, contabilidad por partida doble, mercantilismo, revolucion industrial, comercio a larga distancia
...
`docs/research/corpus/extractos/economia.md`
