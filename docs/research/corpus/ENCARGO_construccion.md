...
Sustituye `construccion`, `construccion_hidraulica.md` y `mamposteria, arco y boveda, hormigon romano, acueducto, noria y tornillo de Arquimedes, presa, molino de agua, cimentacion, puente` y lánzalo.
...
Asuntos a cubrir: mamposteria, arco y boveda, hormigon romano, acueducto, noria y tornillo de Arquimedes, presa, molino de agua, cimentacion, puente
...
`docs/research/corpus/extractos/construccion_hidraulica.md`
