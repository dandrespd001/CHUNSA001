...
Sustituye `textiles`, `textiles.md` y `lana lino algodon seda, hilado, telar, telar mecanico, desmotadora, fibras sinteticas. DECIDIR si merece recurso propio en el juego` y lánzalo.
...
Asuntos a cubrir: lana lino algodon seda, hilado, telar, telar mecanico, desmotadora, fibras sinteticas. DECIDIR si merece recurso propio en el juego
...
`docs/research/corpus/extractos/textiles.md`
