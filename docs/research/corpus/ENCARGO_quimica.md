...
Sustituye `quimica`, `quimica.md` y `polvora (salitre azufre carbon), cal viva y calcinacion, cemento Portland, destilacion fraccionada del petroleo, proceso Haber-Bosch, acido sulfurico` y lánzalo.
...
Asuntos a cubrir: polvora (salitre azufre carbon), cal viva y calcinacion, cemento Portland, destilacion fraccionada del petroleo, proceso Haber-Bosch, acido sulfurico
...
`docs/research/corpus/extractos/quimica.md`
