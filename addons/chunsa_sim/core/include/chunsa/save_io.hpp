...
inline constexpr uint32_t SAVE_FORMAT_VERSION = 20;  // Sprint 1.45: bosques como zonas  // Sprint 1.33: precios de mercado  // Sprint 1.28: ECO_MAX_DEPOSITS 32->64 y EcoDeposit gana 5 campos  // Sprint 1.9C: RESOURCE_COUNT 32->64  // Sprint 1.9: +craft_recipe/craft_progress
